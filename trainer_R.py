...
class Training():
    ...
    def fit(self, train_loader, epochs,  optimizer, scheduler = None):
        ...
        for epoch in range(epochs):
            ...
            if np.isnan(loss_val) == False:
                ...
                if self.epoch % 25 == 0 and self.epoch!= 0:
...
if __name__ == "__main__":
    ...
    params_training['name_for_save'] = 'ckpt_LR_b_32/model_rfdn'
    params_training['name_log_loss'] = 'log_loss_LR_b_32'
